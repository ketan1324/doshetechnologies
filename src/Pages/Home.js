                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-visible">Doshi</b>
                          <b className="is-visible">Technologies</b>
                          <b className="is-visible">Private Ltd.</b>
                      ...
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          ...
                          <li className="wow fadeIn" data-wow-delay=".2s">
                            <a
                              href="https://github.com/ketan1324"
                              target="newtab"
                            >
                              <i
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                        We design and create various websites. And as
                        UI/UX Designer We create many designs for Web
                        Applications and Mobile applications. We create the
                        beauty of the site. We are responsible for the site's
                        technical aspects, such as its performance and capacity,
                        which are measures of a website's speed and how much
                        traffic the site can handle. In addition, We also create
                ...
                <div className="row love-row wow fadeIn">
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".3s">
                      ...
                      <div className="underline1"></div>
                      <div className="underline2"></div>
                      <p>Innovate solution for Businesses,may be be software or IOT 4.0</p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".4s">
                      ...
                      <div className="underline1"></div>
                      <div className="underline2"></div>
                      <p>Mordern Businesses requires mordern solution and we are happy to collaborate.</p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".3s">
                      ...
                      <div className="underline1"></div>
                      <div className="underline2"></div>
                      <p>Love to do Digitalfor new product</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      ...
                      <h2>Saloni Doshi  </h2>
                        <h3>(CTO and Digital marketing)      </h3>
                        <br></br>
                        <h2>Ketan Doshi                    </h2>
                  ...
                  <div className="col-md-4 col-sm-6">
                    <div className="service-details" data-wow-delay=".1s">
                      ...
                      <div className="service-bottom">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Digital marketing : Using Facebook,instagram,twitter and many more.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        <h3>Email</h3>
                        <a
                          href="mailto:connect@doshitechnologies.com"
                          style={{
                            color: "black",
                            textDecoration: "none",
                            fontSize: "17px",
                  ...
                  <div class="col-md-12 col-sm-12 map-col">
                    <div class="google-maps">
                      <div class="map-wrap">
                        <iframe
                          title="google-maps"
                          src="https://maps.google.com/maps?q=satara&t=&z=13&ie=UTF8&iwloc=&output=embed"
                          width="100%"
                          height="450"
                          style={{ border: "0" }}
                          allowfullscreen=""
